...
const IAEval2: FC = () => {
  ...
  const handleChange2 = (event: React.ChangeEvent<HTMLInputElement>) => { // Handler for the second question
...
<div className="flex justify-center"> {/* Add this container */}
      ...
      <div className="flex flex-col items-center justify-center mt-10">
        ...
        <p className="text-black-500 text-xl font-bold mt-3">Pre-Audit Proper</p><br></br>
