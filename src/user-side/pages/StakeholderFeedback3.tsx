      ...
      <div className="flex flex-col items-center justify-center mt-6">
        <div className="bg-gray-100 p-8 rounded-lg w-full sm:w-[700px] h-auto sm:h-[800px] flex flex-col items-center justify-center">
          ...
          <select id="page3-academicUnit" className="mt-3 mb-5 bg-white border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:border-blue-500">
            ...
            <option value="option5">COMMERCE AND BUSINESS ADMINISTRATION, College of</option>
            ...
            <option value="option11">INFORMATION AND COMPUTING SCIENCES, College of</option>
            ...
            <option value="option16">PHYSICAL EDUCATION AND ATHLETICS, Institute of</option>
            <option value="option17">REHABILITATION SCIENCES, College of</option>
            <option value="option18">RELIGION, Institute of</option>
            <option value="option19">SCIENCE, College of</option>
            <option value="option20">TOURISM AND HOSPITALITY MANAGEMENT, College of</option>
          ...
          <select id="page3-concern" className="mt-3 mb-5 bg-white border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:border-blue-500">
            ...
            <option value="option4">Co-curricular/Extra-curricular Activities</option>
