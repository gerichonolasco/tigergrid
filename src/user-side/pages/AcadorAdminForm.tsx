...
const AcadorAdminForm: FC = () => {
    return (
        <div className="flex justify-center h-screen mt-32">
            <Link to="/academicformplan"> {/* Add Link component and specify route */}
            ...
            <Link to="/route2"> {/* Add Link component and specify route */}
                <div className="flex flex-col items-center">
                    ...
                    <span className="text-sm mt-1 font-bold">Admin</span>
                </div>
            </Link>
        </div>
    );
...
export default AcadorAdminForm;
