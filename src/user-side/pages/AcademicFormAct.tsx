        ...
        <p className="text-black-500 text-xl font-bold mt-3">4. Act</p><br></br>
              ...
              <div className="flex flex-row space-x-4">
                {[1, 2, 3, 4, 5].map((number) => (
                 <div key={number} className="flex flex-col items-center">
                    ...
                    />
                    <label htmlFor={`acad-act-q1-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                      {number}
                    </label>
                 </div>
                ))}
                ...
                {[1, 2, 3, 4, 5].map((number) => (
                 <div key={number} className="flex flex-col items-center">
                    <input
                      ...
                      className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-act-q2-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                      {number}
                    </label>
                 </div>
                ))}
                ...
                {[1, 2, 3, 4, 5].map((number) => (
                 <div key={number} className="flex flex-col items-center">
                    <input
                      ...
                      className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-act-q3-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                      {number}
                    </label>
                 </div>
                ))}
                ...
                {[1, 2, 3, 4, 5].map((number) => (
                 <div key={number} className="flex flex-col items-center">
                    <input
                      ...
                      className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-act-q4-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                      {number}
                    </label>
                 </div>
                ))}
            ...
            <div className="flex flex-row space-x-4">
                ...
                <div key={number} className="flex flex-col items-center">
                    ...
                    className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-act-q5-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                    {number}
                    </label>
                </div>
                ))}
