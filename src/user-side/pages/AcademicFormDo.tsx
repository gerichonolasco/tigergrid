        ...
        <p className="text-black-500 text-xl font-bold mt-3">2. Do</p><br></br>
                ...
                {[1, 2, 3, 4, 5].map((number) => (
                 <div key={number} className="flex flex-col items-center">
                    <input
                      ...
                      className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-do-q1b-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                      {number}
                    </label>
                 </div>
                ))}
                ...
                {[1, 2, 3, 4, 5].map((number) => (
                 <div key={number} className="flex flex-col items-center">
                    <input
                      ...
                      className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-do-q1c-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                      {number}
                    </label>
                 </div>
                ))}
                ...
                {[1, 2, 3, 4, 5].map((number) => (
                 <div key={number} className="flex flex-col items-center">
                    <input
                      ...
                      className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-do-q2-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                      {number}
                    </label>
                 </div>
                ))}
            ...
            <div className="flex flex-row space-x-4">
                ...
                <div key={number} className="flex flex-col items-center">
                    ...
                    className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-do-q3-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                    {number}
                    </label>
                </div>
                ))}
            ...
            <div className="flex flex-row space-x-4">
                ...
                <div key={number} className="flex flex-col items-center">
                    ...
                    className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-do-q4-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                    {number}
                    </label>
                </div>
                ))}
            ...
            <div className="flex flex-row space-x-4">
                ...
                <div key={number} className="flex flex-col items-center">
                    ...
                    className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-do-q5-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                    {number}
                    </label>
                </div>
                ))}
            ...
            <div className="flex flex-row space-x-4">
                ...
                <div key={number} className="flex flex-col items-center">
                    ...
                    className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-do-q6-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                    {number}
                    </label>
                </div>
                ))}
            ...
            <div className="flex flex-row space-x-4">
                ...
                <div key={number} className="flex flex-col items-center">
                    ...
                    className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-do-q7-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                    {number}
                    </label>
                </div>
                ))}
            ...
            <div className="flex flex-row space-x-4">
                ...
                <div key={number} className="flex flex-col items-center">
                    ...
                    className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-do-q8a-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                    {number}
                    </label>
                </div>
                ))}
            ...
            <div className="flex flex-row space-x-4">
                ...
                <div key={number} className="flex flex-col items-center">
                    ...
                    className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-do-q8b-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                    {number}
                    </label>
                </div>
                ))}
            ...
            <div className="flex flex-row space-x-4">
                ...
                <div key={number} className="flex flex-col items-center">
                    ...
                    className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-do-q8c-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                    {number}
                    </label>
                </div>
                ))}
            ...
            <div className="flex flex-row space-x-4">
                ...
                <div key={number} className="flex flex-col items-center">
                    ...
                    className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`acad-do-q8d-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                    {number}
                    </label>
                </div>
                ))}
            ...
            <div className="flex justify-center mt-5">
              ...
              <Link to={nextDisabled ? "#" : "/academicformcheck"} className={`bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ${nextDisabled ? 'opacity-50 cursor-not-allowed' : ''}`}> Next </Link>
            </div>
          </div>
        </div>
      </div>
