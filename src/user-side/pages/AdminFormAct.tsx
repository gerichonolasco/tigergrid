...
<div className="flex justify-center mt-12"> 
      ...
      <div className="flex flex-col items-center justify-center mt-10 mb-6">
        ...
        <p className="text-black-500 text-xl font-bold mt-3">4. Act</p><br></br>
            
            <p className="text-black-500 text-xl font-bold mt-3">
            4.1. Improvements in the status of quality objectives are visible and supported by evidence.
            </p>
              ...
              <div className="flex flex-row space-x-4">
                {[1, 2, 3, 4, 5].map((number) => (
                 <div key={number} className="flex flex-col items-center">
                    ...
                    />
                    <label htmlFor={`admin-act-q1-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                      {number}
                    </label>
                 </div>
                ))}
            ...
            4.2. Developmental training and similar activities to enhance the competences of administrative, academic, and support personnel are sustained.
            </p>
            <div className="flex justify-center mt-5">
              <div className="flex flex-row space-x-4">
                {[1, 2, 3, 4, 5].map((number) => (
                 <div key={number} className="flex flex-col items-center">
                    <input
                      ...
                      className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`admin-act-q2-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                      {number}
                    </label>
                 </div>
                ))}
            ...
            <p className="text-black-500 text-xl font-bold mt-8">
            4.3. Problems and gaps that have been previously encountered or identified are prevented from recurring.
            </p>
            <div className="flex justify-center mt-5">
              <div className="flex flex-row space-x-4">
                {[1, 2, 3, 4, 5].map((number) => (
                 <div key={number} className="flex flex-col items-center">
                    <input
                      ...
                      className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`admin-act-q3-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                      {number}
                    </label>
                 </div>
                ))}
            ...
            <div className="flex justify-center mt-5">
              <div className="flex flex-row space-x-4">
                {[1, 2, 3, 4, 5].map((number) => (
                 <div key={number} className="flex flex-col items-center">
                    <input
                      ...
                      className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`admin-act-q4-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                      {number}
                    </label>
                 </div>
                ))}
                ...
                <p className="text-black-500 text-xl font-bold mt-8">
            4.5 Results of feedback mechanisms are utilized for improvement of outputs and services.
            </p>
            <div className="flex justify-center mt-5">
            <div className="flex flex-row space-x-4">
                {[1, 2, 3, 4, 5].map((number) => (
                <div key={number} className="flex flex-col items-center">
                    ...
                    className="form-radio h-5 w-5 text-gray-600"
                    />
                    <label htmlFor={`admin-act-q5-${number}`} className="block text-center text-gray-700 dark:text-gray-500">
                    {number}
                    </label>
                </div>
                ))}
            ...
            <div className="flex justify-center mt-5">
              <Link to="/adminformcheck" className="bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-5">Back</Link>
