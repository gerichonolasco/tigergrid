      ...
      <div className="flex flex-col items-center justify-center mt-10">
        <div className="bg-gray-100 p-8 rounded-lg w-2/3 flex flex-col items-center justify-center"> 
          ...
          <div className="flex justify-center mt-5">
            ...
            <Link to="/unitoriaform" className="bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Agree</Link>
          </div>
        </div>
      </div>
    </div>
