...
interface ManageStakeholderPage3Props {
...
const ManageStakeholderPage3: FC<ManageStakeholderPage3Props> = ({
  questions,
  question, 
  handleInputChange,
  handleDropdownChange,
    ...
    <div className="text-gray-900 bg-gray-200">
      <div className="p-4 flex">
        <h1 className="text-2xl">
          Manage Stakeholder's Feedback Form - Page 3
        </h1>
      </div>
...
export default ManageStakeholderPage3;
