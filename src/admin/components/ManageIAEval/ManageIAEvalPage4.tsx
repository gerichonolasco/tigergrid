...
interface ManageIAEvalPage4Props {
...
const ManageIAEvalPage4: FC<ManageIAEvalPage4Props> = ({
  questions,
  question,
  handleInputChange,
  handleDropdownChange,
    ...
    <div className="text-gray-900 bg-gray-200">
      <div className="p-4 flex">
        <h1 className="text-2xl">
          Manage Internal Auditor's Evaluation Form - Page 4
        </h1>
      </div>
...
export default ManageIAEvalPage4;
