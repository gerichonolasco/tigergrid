...
interface ManageIAEvalPage3Props {
  users: IAQuestion[];
  user: IAQuestion;
  handleInputChange: (
...
const ManageIAEvalPage3: FC<ManageIAEvalPage3Props> = ({
  users,
  user,
  handleInputChange,
  handleDropdownChange,
  ...
  return (
    <div className="text-gray-900 bg-gray-200">
      <div className="p-4 flex">
        ...
        Manage Internal Auditor's Evaluation Form - Page 3
        </h1>
      </div>
...
export default ManageIAEvalPage3;
