...
const IAAnalytics: FC = () => {
  ...
  useEffect(() => {
    if (selectedYear) {
      axios
        .get(`/api/IA/questions?year=${selectedYear}`)
        .then((response) => {
      ...
      axios
        .get(`/api/IA/responses?year=${selectedYear}`)
        .then((response) => {
    ...
    <div className="flex justify-center items-center bg-cover bg-center bg-main-building">
      <div className="text-gray-900 bg-gray-200">
        <div className="p-4 flex">
          <h1 className="text-2xl">Internal Auditor's Evaluation</h1>
        </div>
        <div className="px-3 py-4 flex justify-center">
          <div className="relative">
            <button
              id="IAFDDropdownDefaultButton"
            ...
            {dropdownOpen && (
              ...
              >
                <ul
                  ...
                  aria-labelledby="IAFDDropdownDefaultButton"
                >
                  <li>
                    <button
