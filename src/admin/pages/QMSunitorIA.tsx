...
const QMSunitorIA: FC = () => {
    return (
        <div className="flex justify-center h-screen mt-32">
            <Link to="/admin/acadoradmin"> {/* Add Link component and specify route */}
            ...
            <Link to="/admin/qmsanalytics"> {/* Add Link component and specify route */}
                <div className="flex flex-col items-center">
