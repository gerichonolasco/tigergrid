        ...
        <div className="flex justify-center h-screen mt-32">
                <Link to="/route1"> {/* Add Link component and specify route */}
                    <div className="flex flex-col items-center">
                        <svg className="h-56 w-56 text-black-500" width="120" height="120" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <span className="text-sm mt-1 font-bold">Evaluation Score Summary</span>
                    </div>
                </Link>
