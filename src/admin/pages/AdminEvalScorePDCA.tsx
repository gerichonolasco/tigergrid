...
const AdminEvalScorePDCA: FC = () => {
  return (
    <div className="flex justify-center h-screen mt-32">
      <Link to="/admin/adminscoreplan">
...
export default AdminEvalScorePDCA;
